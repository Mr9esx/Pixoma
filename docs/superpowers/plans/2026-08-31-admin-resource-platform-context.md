...
- [x] **Step 3: Implement identity projection**
...
- [x] **Step 1: Write failing type-level test**
...
- [x] **Step 3: Implement platform display**
...
- [x] **Step 3: Implement platform and user columns**
...
- [x] **Step 2: Run frontend tests and checks**
