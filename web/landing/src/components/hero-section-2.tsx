        ...
        <section style={{ paddingTop: appScreenPaddingTop }}>
          <div className="mx-auto w-full max-w-7xl px-6">
            ...
            <Reveal duration={0.8} ease={[0.25, 0.1, 0.25, 1]} y={0}>
              <div className="relative -mx-2 mt-8 overflow-hidden rounded-3xl bg-black p-2 [filter:drop-shadow(0_4px_48px_color-mix(in_oklab,var(--color-orange-500)_12%,transparent))_drop-shadow(0_0_24px_color-mix(in_oklab,var(--color-orange-500)_10%,transparent))] sm:mt-12">
