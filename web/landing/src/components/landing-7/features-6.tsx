    ...
    <section className="py-16 md:py-20">
      <div className="mx-auto max-w-7xl space-y-12 px-6">
        <h2 className="text-muted-foreground relative z-10 max-w-4xl text-balance text-4xl font-medium tracking-tight lg:text-5xl">
          <span className="text-foreground">你的算力，随时连接。</span> <br />{" "}
          多节点调度，按你的方式运行。
        </h2>
        ...
        <div className="max-sm:*:not-last:border-b max-sm:*:not-last:pb-3 mt-12 grid gap-3 *:max-w-xs sm:grid-cols-2 md:mt-16 md:gap-y-6 lg:mt-24 lg:grid-cols-4 lg:gap-6">
          ...
          <p className="text-muted-foreground text-balance">
            <span className="text-foreground font-medium">
              <Bell className="inline size-4 -translate-y-0.5" /> 主动提醒。
            </span>{" "}
            任务完成、节点异常与排队状态即时可见。
          </p>
          ...
          <p className="text-muted-foreground text-balance">
            <span className="text-foreground font-medium">
              <Users className="inline size-4 -translate-y-0.5" /> 统一历史。
            </span>{" "}
            Case、会话与生成结果放在同一个视图里。
          </p>

          <p className="text-muted-foreground text-balance">
            <span className="text-foreground font-medium">
              <LineChart className="inline size-4 -translate-y-0.5" />{" "}
              运行透明。
            </span>{" "}
            节点负载与任务进展无需反复追问。
          </p>
