  ...
  return (
    ...
    >
      ...
      <div className='relative z-10 flex flex-col gap-2'>
        <h3 className='text-[14px] font-semibold tracking-tight text-zinc-900 dark:text-white'>
          {item.title}
        </h3>
        <p className='text-[12.5px] leading-relaxed text-zinc-500 dark:text-white/40'>
          {item.description}
        </p>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className='relative mb-8 flex flex-col gap-1.5'>
        <p className='text-[10px] font-semibold tracking-[0.22em] text-indigo-600 uppercase dark:text-indigo-400/80'>
          {eyebrow}
        </p>
